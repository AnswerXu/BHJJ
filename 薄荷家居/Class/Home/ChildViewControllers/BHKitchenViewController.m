...
#import "BHKitchenViewController.h"

@interface BHKitchenViewController ()

@end

@implementation BHKitchenViewController
...
-(void)requestDatas{
    ...
    [helper Get:kKitchen parameter:paramers success:^(id obj) {
        if (self.isDown) {
