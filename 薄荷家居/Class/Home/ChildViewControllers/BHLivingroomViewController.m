...
#import "BHLivingroomViewController.h"

@interface BHLivingroomViewController ()

@end

@implementation BHLivingroomViewController
...
-(void)requestDatas{
    ...
    [helper Get:kLivingRoom parameter:paramers success:^(id obj) {
        if (self.isDown) {
